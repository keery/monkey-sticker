  ...
  return (
    <form action={formAction} className="grid items-start gap-8 lg:grid-cols-2">
      ...
      <div className="space-y-5">
        ...
        {/* Variantes de couleur (optionnel) : plusieurs couleurs de la même
            carte, chacune avec sa propre image ; le client devra en choisir une.
            Le cadrage (ci-dessus) est partagé par toutes les couleurs. */}
        <VariantsEditor
          initial={design?.variants}
